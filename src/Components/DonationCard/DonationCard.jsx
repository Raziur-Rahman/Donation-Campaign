...
const DonationCard = ({ data }) => {
    ...
    return (
        <div>
            <div >
                <div className="card card-side bg-base-100 " style={{ backgroundColor: Card_B_Bg }}>
                    <figure><img className="h-full w-[150px] md:w-fit " src={Image[1]} alt="Movie" /></figure>
                    <div className="card-body px-2 md:px-5">
                        <p className="py-2 px-4 rounded-md w-fit font-semibold" style={{ backgroundColor: CategoryBackground, color: CategoryTextColor }}>{Category}</p>
